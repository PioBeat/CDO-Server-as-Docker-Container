...
filename=eclipse-modeling-cdo-2020-06-R-linux-gtk-x86_64.tar.gz
url=https://github.com/PioBeat/CDO-Server-as-Docker-Container/releases/download/v4.10/${filename}
